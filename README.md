...
<a href="https://addons.mozilla.org/zh-CN/firefox/addon/flag-trace/"><img src="https://img.shields.io/amo/v/flag-trace?color=blue" alt="Firefox Add-on"></a>
...
在工具栏图标或者URL地址栏上  
动态显示服务器所属国家/地区的标准化国旗徽标  

通过扩展右键菜单 提供域名、IP等工具（支持自定义）
